...
namespace chst
{
	...
	std::string GetShaderLog(uint32_t object);
	std::string GetProgramLog(uint32_t object);
	std::string GetShaderType(uint32_t type);

	uint32_t Shader::CreateShader(const std::string& vertSrc, const std::string& geomSrc, const std::string& fragSrc)
	{
